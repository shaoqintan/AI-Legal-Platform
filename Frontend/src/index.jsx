...
function App() {
  ...
  async function processMessageToLawAI(chatMessages, newChatMessage) {
    ...
    await fetch(
      ["development", "test"].includes(import.meta.env.MODE)
        ...
        : "https://malai-backend.up.railway.app/chat",
      {
        method: "POST",
        headers: {
        ...
        <MainContainer>
          <ChatContainer>
            <MessageList
              ...
              typingIndicator={
                isTyping ? <TypingIndicator content="LawAI is typing" /> : null
              }
            >
